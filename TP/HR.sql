/* (ID=101) todos os empregados com quem um certo empregado ja trabalhou */ EXEC TIME = 0.288
...
/* top 5 empregados mais antigos em cada regiao */ EXEC TIME = 0.076
...
/* (ID = 176) trabalho em que um user (com varios trabalhos no historico) faturou mais */ EXEC TIME = 0.012
...
/* Media de salarios por departamento */ EXEC TIME = 0.035
select d.department_name as Departamento, round(avg(e.salary),2) as Media_Salario from employees e
inner join departments d on e.department_id=d.department_id
group by d.department_name
order by Media_Salario desc;

/* Total de empregadaos que trabalharam em cada departamento */ EXEC TIME = 0.027
